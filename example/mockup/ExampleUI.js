        ...
        return new Promise((resolve, reject) => {
            IO.GetFile(function (content) {
                ...
                for (let i = 6; i < data.length; i += 6) {
                    ...
                    if(data[i] === 'O3' || data[i] === 'O2' || data[i] === 'O1') inputOrientation = [ "xyz", "xzy", "zyx", "zxy", "yxz", "yzx"];
                    if(data[i] === 'I3' || data[i] === 'I2' || data[i] === 'I1') inputOrientation = [ "xyz", "zyx", "yxz",  "zxy"];
                    var item = {
                        ID: data[i],
                        Dim1: data[i + 1],
                        Dim2: data[i + 2],
                ...
                function roll() {
                    ...
                    if (item) {
                        ...
                        let boxInput = {
                            ...
                            validOrientations: item.Orientation,
